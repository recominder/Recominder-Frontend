  ...
  return (
    <div id="wrapper">
      ...
      <section className="white" id="services">
        <div className="copy is-hidden"><img alt="placeholder" src={require("../assets/phoneScreens.png")} height={600} /></div>
        <div className="log" />
        ...
        <div className="watch"><img alt="placeholder" src={require("../assets/watchFace.png")} height={500} /></div>
        <div className="title">
          <br />
          How Does It Work?
        </div>
        ...
        <div className="flex-container thin-width">
          <div className="column">
            <div className="icons"><img alt="placeholder" src={require("../assets/waterDroplet.png")} height={50} /></div>
            <h3>Water Intake</h3>
          ...
          <div className="column">
            <div className="icons"><img alt="placeholder" src={require("../assets/runningman.png")} height={50} /></div>
            <h3>Exercise Time</h3>
