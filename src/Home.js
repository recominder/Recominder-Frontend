    ...
    return (
      <div id="wrapper">
        ...
        <section className="white" id="services">
          ...
          <div className="title"><br />How Does It Work?</div>
          ...
          <div className="flex-container thin-width">
            <div className="column">
              ...
              <a href="/serieskit" className="inline-cta">Learn More <i>→</i></a>
            </div>
            <div className="column">
              ...
              <a href="/sermonclips" className="inline-cta">Learn More <i>→</i></a>
            </div>
          </div>
        </section>
